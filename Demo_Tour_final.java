...
public class Demo_Tour_final {

	public static void main(String[] args) throws InterruptedException {
		
		//1.open browser
		System.setProperty("webdriver.gecko.driver", "C:\\Users\\acer\\Desktop\\Selenium_jar\\geckodriver-v0.29.1-win64\\geckodriver.exe");
		...
		Thread.sleep(2000);
		w.findElement(By.linkText("REGISTER")).click();
		w.findElement(By.name("firstName")).sendKeys("singamala");
		w.findElement(By.name("lastName")).sendKeys("prasanthi");
		w.findElement(By.name("phone")).sendKeys("1234546578");
		w.findElement(By.name("userName")).sendKeys("prasanthisig@gmail.com");
		w.findElement(By.name("address1")).sendKeys("Rajampet");
		...
		w.findElement(By.name("email")).sendKeys("prasanthisig@gmail.com");
